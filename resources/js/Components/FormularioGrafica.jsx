                ...
                <form className="max-w-2xl mx-auto">
                    ...
                    <div className="flex">
                        <div className="flex-initial mr-2 mb-5 w-1/3">
                            <label htmlFor="puntuacion_gaming" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Memoria de video(Mb)</label>
                        ...
                        <div className="flex-initial mb-5 w-1/3">
                            <label htmlFor="puntuacion_escritorio" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">GDDR</label>
                            <input type="text" id="puntuacion_escritorio" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Introduzca un valor numerico" min="3" max="5" required/>
                        </div>
                        <div className="flex-initial mb-5 w-1/3">
                            <label htmlFor="puntuacion_escritorio" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Consumo(w)</label>
