...
export default function Filtro({ categorias, marcas }) {
    return (
        <aside id="default-sidebar" className="hidden md:block xs:block pl-10 min-w-80 max-h-60" aria-label="Sidebar">
            ...
            <div className="my-3 max-h-72 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <fieldset>
                    <ul className="space-y-2 font-medium">
                        {categorias.map((cat) => (
                            <li key={cat.id}>
                                <input value={cat.id} name="componente" type="radio" />
            ...
            <div className="my-3 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                ...
                <input type="number" name="" id="" className="max-w-14 bg-black text-white rounded-md placeholder-white" placeholder='Min' />
                <label htmlFor="">  a  </label>
                <input type="number" name="" id="" className="max-w-14 bg-black text-white rounded-md placeholder-white" placeholder='Max' />
            </div>
            ...
            <div className="my-3 max-h-72 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                ...
                <ul className="space-y-2 font-medium">
                    ...
                    {marcas.map((marc) => (
                        <li key={marc.id}>
                            <input value={marc.id} name="marcas" type="radio" />
