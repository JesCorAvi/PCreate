    ...
    return (
        <aside id="default-sidebar" className="hidden md:block xs:block pl-10 min-w-80 max-h-60" aria-label="Sidebar">
            ...
            <div className="my-3 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                ...
                <input type="text" name="precioMinimo" id="" onInput ={(e) =>{filtrar(null, null, e.target.value, null)}} className="max-w-14 bg-black text-white rounded-md placeholder-white" placeholder='Min'  />
                <label htmlFor="">  a  </label>
                <input type="text" name="precioMaximo" id="" onInput ={(e) =>{filtrar(null, null, null, e.target.value)}} className="max-w-14 bg-black text-white rounded-md placeholder-white" placeholder='Max'  />
            </div>
