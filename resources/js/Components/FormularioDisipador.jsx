...
export default function FormularioDisipador({ marcas }) {
            ...
            <div name="placa base" className="min-h-screen">
                <form className="max-w-2xl mx-auto">
                    ...
                    <div className="flex">
                        ...
                        <div className="flex-initial mr-2 mb-5 w-1/3">
                            <label htmlFor="categoria" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Es liquida?</label>
