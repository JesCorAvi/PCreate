...
export default function FormularioCpu({ marcas }) {
                ...
                <form className="max-w-2xl mx-auto">
                    ...
                    <div className="flex">
                        <div className="flex-initial mr-2 mb-5 w-1/3">
                            <label htmlFor="puntuacion_gaming" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nucleos</label>
                        ...
                        <div className="flex-initial mr-2 mb-5 w-1/3">
                            <label htmlFor="puntuacion_servidor" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Frecuencia(Ghz)</label>
                            <input type="number" id="puntuacion_servidor" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Introduzca un valor numerico" min="1" required/>
                        </div>
                        <div className="flex-initial mr-2 mb-5 w-1/3">
                            <label htmlFor="puntuacion_servidor" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Consumo(W)</label>
                            <input type="number" id="puntuacion_servidor" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Introduzca un valor numerico" min="1" required/>
                        </div>
                    </div>
