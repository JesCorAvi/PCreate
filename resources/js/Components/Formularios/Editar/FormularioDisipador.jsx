        ...
        <div name="placa base" className="min-h-screen">
            <form className="max-w-2xl mx-auto" onSubmit={submit}>
                ...
                <div className="flex">
                    ...
                    <div className="flex-initial mb-5 w-1/3">
                        <label htmlFor="liquida" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Es líquida?</label>
                        <input
                            value={data.liquida}
                            checked={data.liquida}
                            type="checkbox"
                            name="liquida"
                            id="liquida"
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
